<!-- Footer -->
  <footer class="footer">
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-lg-4">
          <h5>Newsletter</h5>
          <p>Stay updated with our latest research and field stories.</p>
          <div class="newsletter-form">
            <input type="email" placeholder="Your email address">
            <button class="btn-agri" style="padding:12px 24px;">Subscribe</button>
          </div>
        </div>
      </div>
  ...
  <!-- Back to Top -->
  <button class="back-to-top"><i class="bi bi-chevron-up"></i></button>
